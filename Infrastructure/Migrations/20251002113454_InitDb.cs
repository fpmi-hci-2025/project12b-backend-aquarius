        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokensId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageUrl = table.Column<byte[]>(type: "bytea", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_PickupAddresses_ShippingAddressId",
                        column: x => x.ShippingAddressId,
                        principalTable: "PickupAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book-Author", x => new { x.BookId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_Book-Author_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Book-Author_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book-Genre", x => new { x.BookId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_Book-Genre_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Book-Genre_Genres_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wishlist-Book", x => new { x.WishlistId, x.BookId });
                    table.ForeignKey(
                        name: "FK_Wishlist-Book_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wishlist-Book_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Book-Author_AuthorId",
                table: "Book-Author",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Book-Genre_GenreId",
                table: "Book-Genre",
                column: "GenreId");
